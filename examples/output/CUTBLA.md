...
- **WV-CUST-NAME** (line 28, CRITICAL): `05 WV-CUST-NAME PIC X(30) DISPLAY` → `05 WV-CUST-NAME PIC X(50).`
- **WV-VALUE** (line 26, CRITICAL): `05 WV-VALUE PIC S9(10)V9(2) DISPLAY` → `05 WV-VALUE PIC S9(13)V9(2).`
